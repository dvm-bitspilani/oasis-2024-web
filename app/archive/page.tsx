...
// const imageClasses = [
//     styles.hStrech, styles.hStrech, styles.vStrech, styles.pic, styles.pic, styles.vhStrech,
//     styles.pic, styles.vStrech, styles.pic, styles.vStrech, styles.hStrech, styles.pic,
//     styles.hStrech, styles.pic, styles.vStrech, styles.largeScreen, styles.pic, styles.hStrech,
//     styles.hStrech, styles.pic
// ];
  ...
  return (
    <>
      ...
      <div className={styles.galleryContainer}>
        ...
        {isCarouselOpen && (
          <Carousel
            activeEvent={currentIndex}
            maxIndex={images.length - 1}
            isTransitioning={false}
            carouselContent={{ image: images[currentIndex] }}
