...
const eventImages = [
  ...
  [seventeen, eight, nineteen, twenty, twentyone]
];
...
const Gallery: React.FC = () => {
  ...
  const handleClick = (direction: string) => {
    if (direction === "forward") {
      setCategoryIndex((prevIndex) => (prevIndex + 1) % eventCategories.length);
    } else {
      setCategoryIndex((prevIndex) =>
        prevIndex === 0 ? eventCategories.length - 1 : prevIndex - 1
      );
    }
  };
    ...
    <>
      ...
      <div className={styles.pageWrapper}>
        ...
        <div className={styles.pdfContainer}>
          <GalleryGrid
            eventImg={eventImages[categoryIndex]}
            eventName={eventNames[categoryIndex]}
            eventCategory={eventCategories[categoryIndex]}
          />
        </div>
      </div>
    </>
