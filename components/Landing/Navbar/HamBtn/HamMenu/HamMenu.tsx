  ...
  return (
    <div className={styles.hamMenuLines}>
      <div className={styles.wallMag} ref={wallMagRef}>
        ...
        <Link href="" className={styles.magText}>
          WALL MAG
        </Link>
      </div>
      <div className={styles.developers} ref={developersRef}>
        ...
        <Link href="" className={styles.devText}>
          DEVELOPERS
        </Link>
      </div>
      <div className={styles.mediaPartners} ref={mediaPartnersRef}>
        <svg
          ...
          xmlns="http://www.w3.org/2000/svg"
        >
          <path d="M0 2.08586L305 2.08511" stroke="#F5E3AE" stroke-width="3" />
          <path
        ...
        <Link href="" className={styles.medText}>
          MEDIA PARTNERS
        </Link>
      </div>
      <div className={styles.sponsors} ref={sponsorsRef}>
        ...
        <Link href="" className={styles.sponsorsText}>
          SPONSORS
        </Link>
      </div>
      <div className={styles.gallery} ref={galleryRef}>
        ...
        <Link href="" className={styles.galleryText}>
          GALLERY
        </Link>
      </div>
    </div>
